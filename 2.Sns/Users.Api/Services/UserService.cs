...
namespace Users.Api.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUserRepository userRepository, IMapper mapper, ISnsMessenger sqsMessenger)
        {
        ...
        public async Task<bool> CreateAsync(Domain.User user)
        {
            ...
            if (response)
            {
                ...
                await _sqsMessenger.PublishMessageAsync(_user);
            }
        ...
        public async Task<bool> DeleteAsync(int id)
        {
            ...
            if (response)
            {
                await _sqsMessenger.PublishMessageAsync(new UserDeleted
                {
                    Id = id
                });
            }
